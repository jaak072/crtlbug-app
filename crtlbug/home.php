...
<body>
    ...
    <div class="my-5 py-5 px-md-5 px-3 flex-grow-1">
        ...
        <?php } else { ?>
        <h2 class="text-center text-md-left mt-5">You don't have any active plans.</h2>
        ...
        <div class="row mt-4">
            ...
            <?php if(mysqli_num_rows($plans)>0) { ?>
            <div class="container">
                    <a href="new_plan" class="text-success " style="text-decoration:none; float: right;"><p><i class="fa fa-5x fa-plus-circle"></i> </p></a>
                </div>
            <?php } ?>
